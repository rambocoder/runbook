...
var CustomerForm_1 = require("../src/CustomerForm");
describe('CustomerForm', function () {
    var render, container;
    var form = function (id) { return container.querySelector("form[id=\"" + id + "\""); };
    var expectToBeInputFieldOfTypeText = function (formElement) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    render(react_1.default.createElement(CustomerForm_1.CustomerForm, { customerName: "Mike", onSubmit: function (_a) {
